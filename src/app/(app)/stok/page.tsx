    ...
    <div className="space-y-2">
      ...
      {MOCK_STOK_URUNLERI.map((urun) => (
        <Link key={urun.id} href={`/stok/detay?id=${urun.id}`}>
          <Kart stripRengi={urun.adet === 0 ? "#C4341E" : urun.adet < 10 ? "#B4740E" : "#0F7A4C"}>
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-xs text-gray-500 font-mono">{urun.urunKodu}</p>
              ...
              <span className="text-sm font-semibold shrink-0">{urun.adet} adet</span>
            </div>
          </Kart>
        </Link>
      ))}
